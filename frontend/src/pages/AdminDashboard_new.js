              ...
              Total Results: {
                trainings.filter(t => {
                  ...
                  return (
                    ...
                    (!filterTrainingStatus || t.status === filterTrainingStatus) &&
                    (
                ...
                {trainings.filter(t => {
                  ...
                  <div key={training.id} className="data-card" onClick={() => setDetailTraining(training)}>
                    ...
                    <div className="data-card-content">
                      ...
                      <div className="mb-2">
                        <span className={`badge ${
                          ...
                          training.status === 'Ongoing' ? 'badge-warning' :
                          training.status === 'Cancelled' ? 'badge-error' :
                          'badge-secondary'
                        }`}>
                          {training.status}
                        </span>
                    ...
                    <div className="data-card-meta">
                      ...
                      <span>{training.current_trainees || 0}/{training.max_trainees}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="space-y-3">
                ...
                <div><strong>Capacity:</strong> {detailTraining.current_trainees || 0}/{detailTraining.max_trainees}</div>
                <div><strong>Status:</strong> 
                  <span className={`badge ml-2 ${
                    detailTraining.status === 'Completed' ? 'badge-success' :
                    detailTraining.status === 'Ongoing' ? 'badge-warning' :
                    detailTraining.status === 'Cancelled' ? 'badge-error' :
                    'badge-secondary'
                  }`}>
